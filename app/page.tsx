...
export default function Home()
{
  return (
    <main className="w-screen h-screen relative">
      ...
      >
        <div className="pl-20 md:pl-40 pb-56 md:pb-20 flex flex-col gap-5 z-[10] max-w-[790px]">
          ...
          <p className="text-gray-200 hidden md:block">
            <span className="highlight-letters">A</span>ndrey <span className="highlight-letters">Z</span>inchenko, software specialist, 20+ years of experience
            in developing large scale projects for Telecom and Fintech...
          </p>
